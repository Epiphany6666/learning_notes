...
参考视频以及资料借鉴网址：[【Typora 教程】手把手教你如何用Typora撰写笔记_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1h84y1Y7nn/?spm_id_from=333.337.search-card.all.click)

该博客是根据视频和笔记进行个人习惯的修改。
...
打开自动保存、关闭自动检查更新、关闭发送匿名使用数据

![image-20240325213918652](assets/image-20240325213918652.png)
...
![image-20240325214247902](assets/image-20240325214247902.png)



## 3）编辑器

如果不想让单词经常出现爆红的情况，建议直接将拼写检查选择为 `不使用拼写检查`

![image-20240325214520681](assets/image-20240325214520681.png)



## 4）图像

如果想要图片在插入时自动保存到指定文件夹，可以按照如图设置。如果想要结合PicGo，可以参考我的这篇博客：[Typora结合PicGo + 使用Github搭建个人免费图床](https://blog.csdn.net/qq_39921135/article/details/136278309?spm=1001.2014.3001.5502)

![image-20240325214659202](assets/image-20240325214659202.png)
...
![image-20240325215244168](assets/image-20240325215244168.png)

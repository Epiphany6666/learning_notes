...
1. 什么是 AJAX ? [mdn](https://developer.mozilla.org/zh-CN/docs/Web/Guide/AJAX/Getting_Started)
   ...
   ![image-20240101104158376](.\images\image-20240101104158376.png)
...
2. 什么是 URL ？
   ...
   * 统一资源定位符，简称网址，用于定位网络中的资源（资源指的是：网页，图片，数据，视频，音频等等）
     ...
     ![image-20240101131303246](.\images\image-20240101131303246.png)
...
3. axios 如何提交数据到服务器呢？
   ...
   * data里面要传对象还是数组，需要查看接口文档
     ...
     ![image-20240117141254746](.\images\image-20240117141254746.png)
...
![image-20240101151731360](.\images\image-20240101151731360.png)
...
![image-20240101154333093](.\images\image-20240101154333093.png)

标头 --> 请求标头（这里面就是我们要看的请求报文的信息了）

但是由于浏览器对请求报文进行了格式化，所以需要点击旁边的（原始）

![image-20240101154530637](.\images\image-20240101154530637.png)

**查看请求体**：载荷 --> 查看原数据，此时就可以看见json格式的数据了

![image-20240101154719744](.\images\image-20240101154719744.png)
...
![image-20240101155843957](.\images\image-20240101155843957.png)
...
![image-20240101160824514](.\images\image-20240101160824514.png)

查看**响应体**：

![image-20240101160949427](.\images\image-20240101160949427.png)

旁边的预览就是谷歌浏览器会对响应体进行格式化

![image-20240101161027297](.\images\image-20240101161027297.png)
...
![image-20240101164450393](.\images\image-20240101164450393.png)
...
1. 什么是 Bootstrap 弹框？
   ...
   * 不离开当前页面，显示单独内容，供用户操作
     ...
     ![image-20230404105801739](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404105801739.png)

2. 需求：使用 Bootstrap 弹框，先做个简单效果，点击按钮，让弹框出现，点击 X 和 Close 让弹框隐藏

   ![image-20230404105858660](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404105858660.png)
...
3. 如何使用 Bootstrap 弹框呢？
   ...
   2. 准备弹框标签，确认结构（可以从 Bootstrap 官方文档的 Modal 里复制基础例子）- 运行到网页后，逐一对应标签和弹框每个部分对应关系
      ...
      ![image-20240115153352055](.\images\image-20240115153352055.png)
...
1. 为什么需要 JS 方式控制呢？
   ...
   * 例如：
     ...
     * 点击保存按钮，在弹框隐藏之前，获取用户填入的名字并打印
     ...
     ![image-20230404110038828](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404110038828.png)
...
1. 需求：基于 axios 获取到图书列表数据，并用 JS 代码渲染数据，到准备好的模板标签中
   ...
   ![image-20230404110943200](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404110943200.png)
...
2. 步骤：
   ...
   2. 渲染数据
      ...
      ![image-20230404110953752](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404110953752.png)

      ![image-20230404111014560](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404111014560.png)
...
5. 快速复制模版
   ...
   <img src=".\images\image-20240115165312399.png" alt="image-20240115165312399" style="zoom: 33%;" />

   然后直接复制这个结果即可

   <img src=".\images\image-20240115165402430.png" alt="image-20240115165402430" style="zoom:50%;" />

# 20.案例_图书管理\_新增图书

1. 需求：点击添加按钮，出现准备好的新增图书弹框，填写图书信息提交到服务器保存，并更新图书列表

   ![image-20230404111235862](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404111235862.png)

   ![image-20230404111251254](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404111251254.png)
...
2. 步骤：
   ...
   3. 刷新-图书列表）（重新调用下之前封装的获取并渲染列表的函数）
      ...
      ![image-20230404111343653](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404111343653.png)
...
1. 需求：点击图书删除元素，删除当前图书数据
   ...
   ![image-20230404111530311](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404111530311.png)

   ![image-20230404111546639](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404111546639.png)
...
2. 步骤：
   ...
   3. 重新获取并刷新图书列表
      ...
      ![image-20230404111612125](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404111612125.png)
...
2. 需求：完成编辑图书回显当前图书数据到编辑表单，在用户点击修改按钮，收集数据提交到服务器保存，并刷新列表
   ...
   ![image-20230404111722254](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404111722254.png)
...
3. 编辑数据的核心思路：
   ...
   2. 基于 axios 和接口文档，调用查询图书详情接口，获取正在编辑的图书数据，并回显到表单中（页面上的数据是在用户的浏览器中不够准备，所以只要是查看数据都要从服务器获取）
      ...
      ![image-20230404111739153](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404111739153.png)

   3. 收集并提交保存修改数据，并重新从服务器获取列表刷新页面

      ![image-20230404111756655](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404111756655.png)
...
1. 因为增删改查的业务在前端实际开发中非常常见，思路是可以通用的，所以总结下思路
   ...
   ![image-20230404111941722](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404111941722.png)
...
3. 新增数据（增）
   ...
   ![image-20230404112942935](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404112942935.png)
...
4. 删除图书（删）
   ...
   ![image-20230404113338815](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404113338815.png)
...
5. 编辑图书（改）
   ...
   ![image-20230404113702515](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404113702515.png)
...
5. 接口文档中的form-data指的就是表单数据对象
   ...
   ![image-20240120155216335](.\images\image-20240120155216335.png)
...
1. 需求：先运行备课代码，查看要完成的效果，点击右上角选择本机中提供的素材图片，更换网站背景图
   ...
   ![image-20230404122349505](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404122349505.png)
...
1. 需求：先运行备课代码，查看要完成的效果
   ...
   ![image-20230404123206073](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404123206073.png)
...
1. 需求：把外号对应的个人信息和头像，渲染到页面表单和头像标签上。
   ...
   ![image-20230404123708765](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404123708765.png)
...
1. 需求：点击修改用户头像
   ...
   ![image-20230404124524401](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404124524401.png)
...
2. 实现步骤如下：
   ...
   3. 提交到服务器保存此用户对应头像文件，并把返回的头像图片 url 网址设置在页面上
      ...
      ![image-20230404124540629](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404124540629.png)
...
1. 需求：点击提交按钮，收集个人信息，提交到服务器保存（无需重新获取刷新，因为页面已经是最新的数据了）
   ...
   2. 提交到服务器保存-调用用户信息更新接口（注意请求方法是 PUT）代表数据更新的意思
      ...
      ![image-20230404125310049](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404125310049.png)
...
1. 需求：使用 bootstrap 提示框，提示个人信息设置后的结果
   ...
   ![image-20230404125517679](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day02_AJAX综合案例/02-笔记/images/image-20230404125517679.png)
...
![image-20240116162008069](.\images\image-20240116162008069.png)
...
![image-20230221182835545](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day03_AJAX原理/02-笔记/images/image-20230221182835545.png)
...
![image-20230221183057392](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day03_AJAX原理/02-笔记/images/image-20230221183057392.png)
...
<body>
  ...
  <script>
    ...
    */
    ...
    // 3. 监听 loadend 事件，接收响应结果
    // 去MDN网站可以看见很多种事件，但是loadend无论成功还是失败，它都会执行回调函数
    xhr.addEventListener('loadend', () => {
      console.log(xhr.response)
      // 在使用axios的时候，它会把返回的数据从JSON字符串转成JS对象，而在使用原生XHR对象的时候，就没有人帮我们做这件事情
      // axios内部把这个结果转换完后，它会挂载到结果对象的data属性下
      const data = JSON.parse(xhr.response)
      // 如果直接打印，它会有一个数组转字符串的隐式转换，所以最好还是自己转为字符串
...
4. 需求：查询河北省下属的城市列表
   ...
   ![image-20230404133429378](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day03_AJAX原理/02-笔记/images/image-20230404133429378.png)
...
1. 需求：和我们之前做的类似，就是不用 axios 而是用 XHR 实现，输入省份和城市名字后，点击查询，传递多对查询参数并获取地区列表的需求
   ...
   ![image-20230221184135458](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day03_AJAX原理/02-笔记/images/image-20230221184135458.png)
...
3. 下图叫做URL编码，而不是乱码
   ...
   ![image-20240116174753530](.\images\image-20240116174753530.png)
...
2. 需求：通过 XHR 完成注册用户功能
   ...
   ![image-20230404135245271](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day03_AJAX原理/02-笔记/images/image-20230404135245271.png)
...
2. Promise 的好处是什么？
   ...
   * 了解 axios 函数内部运作的机制
     ...
     ![image-20230222113651404](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day03_AJAX原理/02-笔记/images/image-20230222113651404.png)
...
3. Promise 的状态改变有什么用：调用对应函数，改变 Promise 对象状态后，内部触发对应回调函数传参并执行
   ...
   ![image-20230222120815484](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day03_AJAX原理/02-笔记/images/image-20230222120815484.png)
...
2. 需求：使用 Promise 和 XHR 请求省份列表数据并展示到页面上
   ...
   ![image-20230404140252181](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day03_AJAX原理/02-笔记/images/image-20230404140252181.png)
...
1. 需求：基于 Promise 和 XHR 封装 myAxios 函数，获取省份列表展示到页面
   ...
   ![image-20230222130217597](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day03_AJAX原理/02-笔记/images/image-20230222130217597.png)
...
![image-20230222133327806](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day03_AJAX原理/02-笔记/images/image-20230222133327806.png)
...
1. 介绍本视频要完成的效果：搜索匹配关键字相关城市名字，展示城市列表即可
   ...
   ![image-20230222133553010](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day03_AJAX原理/02-笔记/images/image-20230222133553010.png)
...
1. 介绍本视频要完成的效果：点击城市列表名字，切换当前页面天气数据
   ...
   ![image-20230222134653884](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day03_AJAX原理/02-笔记/images/image-20230222134653884.png)
...
1. 需求：展示默认第一个省，第一个城市，第一个地区在下拉菜单中
   ...
   ![image-20230222173109762](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day04_AJAX进阶/02-笔记/images/image-20230222173109762.png)
...
3. 好处：通过链式调用，解决回调函数嵌套问题
   ...
   ![image-20230222173851738](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day04_AJAX进阶/02-笔记/images/image-20230222173851738.png)
...
2. 做法：每个 Promise 对象中管理一个异步任务，用 then 返回 Promise 对象，串联起来
   ...
   ![image-20230222174946534](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day04_AJAX进阶/02-笔记/images/image-20230222174946534.png)
...
1. 定义：
   ...
   ![image-20240118132440848](.\images\image-20240118132440848.png)
...
2. 尝试把代码中 url 地址写错，运行观察 try catch 的捕获错误信息能力
   ...
   >
   > ![image-20240118134210143](.\images\image-20240118134210143.png)
   >
   > 这里的message是axios做了一些处理，返回的提示消息，如果需要接口返回的真正响应的数据，应该看response（响应），然后找到data
   >
   > 或者直接在浏览器里找响应结果
   >
   > ![image-20240118134338688](.\images\image-20240118134338688.png)
   >
...
1. 概念：
   ...
   ![image-20240118142809647](.\images\image-20240118142809647.png)
...
5. 概念：执行代码和收集异步任务的模型，在调用栈空闲，反复调用任务队列里回调函数的执行机制，就叫事件循环
   ...
   */
   ...
   ![image-20230222182338992](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day04_AJAX进阶/02-笔记/images/image-20230222182338992.png)
...
myFn()
   ...
   ![image-20230222183656761](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day04_AJAX进阶/02-笔记/images/image-20230222183656761.png)
...
3. 宏任务和微任务具体划分：
   ...
   ![image-20230222184920343](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day04_AJAX进阶/02-笔记/images/image-20230222184920343.png)
...
4. 事件循环模型
   ...
   ![image-20230222184949605](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day04_AJAX进阶/02-笔记/images/image-20230222184949605.png)
...
![image-20230222185205193](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day04_AJAX进阶/02-笔记/images/image-20230222185205193.png)
...
![image-20230222185939276](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day04_AJAX进阶/02-笔记/images/image-20230222185939276.png)

# 57.Promise.all 静态方法

1. 概念：合并多个 Promise 对象，等待所有**同时成功**完成（或某一个失败），做后续逻辑

   ![image-20230222190117045](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day04_AJAX进阶/02-笔记/images/image-20230222190117045.png)
...
3. 需求：同时请求“北京”，“上海”，“广州”，“深圳”的天气并在网页尽可能同时显示
   ...
   ![image-20230222190230351](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day04_AJAX进阶/02-笔记/images/image-20230222190230351.png)
...
![image-20240118153713388](.\images\image-20240118153713388.png)
...
1. 需求：尽可能同时展示所有商品分类到页面上
   ...
   ![image-20230222191151264](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day04_AJAX进阶/02-笔记/images/image-20230222191151264.png)
...
1. 需求：完成省市区切换效果
   ...
   ![image-20230222191239971](O:/BaiduSyncdisk/other/课/黑马/AJAX/01.AJAX/代码和笔记/代码和笔记/Day04_AJAX进阶/02-笔记/images/image-20230222191239971.png)
...
![image-20230518105910906](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518105910906.png)
...
![image-20230518105936866](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518105936866.png)
...
![image-20230518110442704](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518110442704.png)
...
![image-20230518110515767](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518110515767.png)
...
![image-20230518110606843](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518110606843.png)
...
![image-20230518110646428](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518110646428.png)
...
![image-20230518110744566](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518110744566.png)
...
![image-20230518110901334](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518110901334.png)
...
![image-20230518110913008](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518110913008.png)
...
![image-20240119181346631](.\images\image-20240119181346631.png)
...
![image-20240119181900574](.\images\image-20240119181900574.png)
...
![image-20230518111044515](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518111044515.png)

同样代码模板也是从官网复制的

验证token过期可以直接自己编一个假的

![image-20240119184655842](.\images\image-20240119184655842.png)
...
![image-20230518111206285](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518111206285.png)
...
![image-20240120140023949](.\images\image-20240120140023949.png)
...
![image-20230518111333428](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518111333428.png)
...
![image-20240120140147914](.\images\image-20240120140147914.png)
...
![image-20240120141935390](.\images\image-20240120141935390.png)

在快速开始底下，有对mode的解释，PS：现在调整的都是编辑器下面相关的配置，而不是工具栏的

![image-20240120143500037](.\images\image-20240120143500037.png)
...
![image-20230518111430023](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518111430023.png)
...
1. 准备标签结构和样式
   ...
   <img src=".\images\image-20240120154048094.png" alt="image-20240120154048094" style="zoom:50%;" />
...
注意：图片地址临时存储在 img 标签上，并未和文章关联保存![image-20230518111505259](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518111505259.png)
...
![image-20230518111530578](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518111530578.png)
...
![image-20230518111554655](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518111554655.png)
...
![image-20230518111611349](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518111611349.png)
...
![image-20230518111702356](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518111702356.png)
...
![image-20230518111815340](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518111815340.png)
...
![image-20230518112012528](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518112012528.png)
...
![image-20230518112036624](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518112036624.png)
...
![image-20230518112112709](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518112112709.png)
...
![image-20230518112137592](O:/BaiduSyncdisk/other/课/黑马/AJAX/02.黑马头条数据管理平台/代码和笔记/02-笔记/images/image-20230518112137592.png)
...
2. 前端工程化：开发项目直到上线，过程中集成的所有工具和技术
   ...
   ![image-20240101171917058](.\images\image-20240101171917058.png)

3. Node.js 作用除了编写后端应用程序，也可以对前端代码进行压缩，转译，整合等等，提高前端开发和运行效率
...
4. Node.js 为何能执行 JS？
   ...
   ![image-20240121211921290](O:\BaiduSyncdisk\other\StudyNote\JavaScript\assets\image-20240121211921290.png)

5. 要求：下载 node-v16.19.0.msi 安装程序（指定版本：兼容 vue-admin-template 模板）

6. 想要得到 Node.js 需要把这个软件安装到电脑，在素材里有安装程序（window 和 mac 环境的）参考 PPT 默认下一步安装即可

7. Node.js 没有图形化界面，需要使用 cmd 终端命令行（利用一些命令来操控电脑执行某些程序软件）输入，node -v 检查是否安装成功

   ```bash
   node -v
   ```

8. 需求：新建 index.js 文件，编写打印代码和 for 循环打印 3 个 6
...
9. Node.js 执行目标 JS 文件，需要使用 node xxx.js 命令来执行（我们可以借助 VSCode 集成终端使用，好处：可以快速切换到目标 JS 文件所在终端目录，利用相对路径找到要执行的目标 JS 文件

   ![image-20230330112925228](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230330112925228.png)

VSCode中默认是powershell终端，它里面不允许我们执行默认的命令

![image-20240121212543061](O:\BaiduSyncdisk\other\StudyNote\JavaScript\assets\image-20240121212543061.png)

选择cmd即可

![image-20240121212617604](O:\BaiduSyncdisk\other\StudyNote\JavaScript\assets\image-20240121212617604.png)

这里可以直接终止终端

![image-20240121212951209](O:\BaiduSyncdisk\other\StudyNote\JavaScript\assets\image-20240121212951209.png)

直接在想要的文件右击，选择在集成终端中打开，这样它就会自动切换终端中的路径

![image-20240121213114653](O:\BaiduSyncdisk\other\StudyNote\JavaScript\assets\image-20240121213114653.png)
...
![image-20240121214506243](O:\BaiduSyncdisk\other\StudyNote\JavaScript\assets\image-20240121214506243.png)
...
2. 新建 03 文件夹编写待执行的 JS 代码，访问外层相对路径下的文件，<span style="color: red;">然后在最外层终端路径来执行目标文件，造成问题</span>
   ...
   ![image-20230330113929178](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230330113929178.png)

   ![image-20230330113942679](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230330113942679.png)
...
![image-20240126112936947](.\images\image-20240126112936947.png)
...
![image-20230330175243783](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230330175243783.png)
...
![image-20230331150152299](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230331150152299.png)
...
![image-20230331150407659](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230331150407659.png)
...
![image-20230331150506876](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230331150506876.png)
...
![image-20230331154702306](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230331154702306.png)

> 许可证其实就是一个英文的固定名字的字符串的值，MIT的意思就是，如果这个软件包以后商用的话，就可以使用当前作者的名字进行一个宣传，所以它就是一个标记而已

![image-20230331154639881](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230331154639881.png)
...
![image-20230331155406652](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230331155406652.png)
...
![image-20230331155537983](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230331155537983.png)
...
1. 我们拿到了一个别人编写的项目，但是没有 node_modules，项目能否正确运行？
   ...
   ![image-20230331162320775](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230331162320775.png)
...
1. 如何得到需要的所有依赖软件包呢？
   ...
   ![image-20230331162341684](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230331162341684.png)
...
![image-20230331170210113](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230331170210113.png)

![image-20230331170220045](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230331170220045.png)
...
![image-20230331170539931](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230331170539931.png)
...
3. Node.js 常用命令：
   ...
   ![image-20230331171411780](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230331171411780.png)
...
![image-20230403105744257](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230403105744257.png)
...
![image-20230403105848637](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230403105848637.png)
...
3. 下载 webpack webpack-cli 到项目（版本独立）
   ...
   ![image-20240127110722542](.\images\image-20240127110722542.png)
   ...
   ![image-20230403110640647](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230403110640647.png)
...
4. 项目中运行工具命令，采用自定义命令的方式（局部命令）
   ...
   ![image-20240127111250165](.\images\image-20240127111250165.png)
...
5. 自动产生 dist 分发文件夹（压缩和优化后，用于最终运行的代码）
   ...
   ![image-20240127111324390](.\images\image-20240127111324390.png)

 6. 需求最终流程图：

    ![image-20230403111445196](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230403111445196.png)
...
![image-20240127112434617](.\images\image-20240127112434617.png)
...
![image-20240127113015990](.\images\image-20240127113015990.png)
...
![image-20230518101043103](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230518101043103.png)
...
1. 新建 public/login.html 准备网页模板（方便查找标签和后期自动生成 html 文件做准备）
   ...
   ![image-20230518101137662](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230518101137662.png)
...
4. 手动复制 public/login.html 到 dist 下，手动引入打包后的 JS 代码文件，运行 dist/login.html 在浏览器查看效果
   ...
   ![image-20230518101404084](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230518101404084.png)
...
![image-20240127122602690](.\images\image-20240127122602690.png)
...
![image-20240127134919976](.\images\image-20240127134919976.png)
...
![image-20240127140413468](.\images\image-20240127140413468.png)
...
![image-20240127141917472](.\images\image-20240127141917472.png)

我们可以阅读 推荐示例 也可以自己百度搜索`webpack 提取 css 代码`这种关键字的方式，但由于我们搜索到的可能是几百年前，可以使用搜索工具进行过滤

但如果有webpack4的，那是因为它买了百度推广的广告，它会置顶在上面

![image-20240127142610826](.\images\image-20240127142610826.png)

下面红框的地方就是Webpack4使用的插件

![image-20240127151246639](.\images\image-20240127151246639.png)
...
![image-20240127152130262](.\images\image-20240127152130262.png)

# 104.优化压缩过程

> 由于我们提取好的css文件，如下图，bootstrap.min.css 文件本身就是压缩好的，而自己写的代码并没有经过压缩
>
> ![image-20240127152328954](.\images\image-20240127152328954.png)

需求：把提出的 css 文件内样式代码压缩

需要：css-minimizer-webpack-plugin 插件来实现

![image-20240127152553072](.\images\image-20240127152553072.png)

具体的使用可以点击 [css-minimizer-webpack-plugin ](https://webpack.docschina.org/plugins/css-minimizer-webpack-plugin/)跳转到详细文档

![image-20240127152816008](.\images\image-20240127152816008.png)

点击之后就来到了具体的文档

![image-20240127153031557](.\images\image-20240127153031557.png)
...
![image-20240127154410214](.\images\image-20240127154410214.png)
...
![image-20240127154800363](.\images\image-20240127154800363.png)
...
![image-20240127161741783](.\images\image-20240127161741783.png)
...
![image-20240127163013820](.\images\image-20240127163013820.png)
...
<img src=".\images\image-20240127163324637.png" alt="image-20240127163324637" style="zoom:50%;" />

此时它匹配到的就是通用类型的位置

![image-20240127163449217](.\images\image-20240127163449217.png)

![image-20240127163629191](.\images\image-20240127163629191.png)
...
![image-20240127163831646](.\images\image-20240127163831646.png)
...
2. 注意：判断临界值默认为 8KB
   ...
   >
   > ![image-20240127165105134](.\images\image-20240127165105134.png)
   ...
   >
   > ![image-20240127165309538](.\images\image-20240127165309538.png)
   >
...
![image-20230518103430262](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230518103430262.png)
...
<img src=".\images\image-20240127181313156.png" alt="image-20240127181421420" style="zoom: 33%;" />

![image-20240127181850464](.\images\image-20240127181850464.png)
...
<img src=".\images\image-20240127182056787.png" alt="image-20240127182056787" style="zoom:50%;" />

告诉我们这个软件包启动的服务，将我们dist目录下的内容会作为我们启动的web服务的静态的资源模块，也就是说我们通过localhost:8080然后/就可以访问这个dist目录下的任意的静态资源的内容

![image-20240127182322074](.\images\image-20240127182322074.png)

如果不知道devServer是什么意思，可以直接进行搜索，此时就会来到devServer相关的设置当中

![image-20240127182645366](.\images\image-20240127182645366.png)

在这里面我们就可以找到static，如果我们不设置static，它的默认值就是public

![image-20240127182823119](.\images\image-20240127182823119.png)
...
<img src=".\images\image-20240127183822526.png" alt="image-20240127183822526" style="zoom:33%;" />
...
![image-20240127184614932](.\images\image-20240127184614932.png)
...
>
> ![image-20240128114107268](.\images\image-20240128114107268.png)
...
- 如果也想让main.css打包进login里
  ...
  <img src=".\images\image-20240128115023215.png" alt="image-20240128115023215" style="zoom:50%;" />
...
>
> ![image-20240128115857752](.\images\image-20240128115857752.png)
>
> ~~~js
> var config = {
>   entry: './app.js',
...
2. 通过命令给NodeJS环境注入环境变量：配置自定义命令，传入参数名和值（会绑定到 process.env 对象下，添加对应的参数名和参数值）
   ...
   ![image-20240128121619290](.\images\image-20240128121619290.png)
...
4. 步骤：
   ...
   ![image-20230518104016802](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230518104016802.png)
...
![image-20240128124827505](.\images\image-20240128124827505.png)
...
>
> ![image-20240128125303817](.\images\image-20240128125303817.png)
...
![image-20240128133423320](.\images\image-20240128132455863.png)

由于source map可以很轻易的定位到报错信息在用户的浏览器中，所以在上线的时候建议不要使用

![image-20240128133450364](.\images\image-20240128132515635.png)
...
![image-20230518104603049](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230518104603049.png)
...
![image-20230518104625088](O:/BaiduSyncdisk/other/课/黑马/AJAX/03.Node.js与Webpack/资料/代码和笔记/02-笔记/images/image-20230518104625088.png)
...
>
> ![image-20240128144738264](.\images\image-20240128144738264.png)
...
![image-20240128150320174](.\images\image-20240128150320174.png)
...
![image-20240128154926184](.\images\image-20240128154926184.png)

wangeditor同样也是，直接复制安装命令即可

![image-20240128155245153](.\images\image-20240128155245153.png)
